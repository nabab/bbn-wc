(bbn => {
  "use strict";
  Object.defineProperty(bbn.wc.mixins, 'basic', {
    configurable: false,
    writable: false,
    value: {
      data(){
        ...
        if (this.$options.name && bbn.wc.defaults[this.$options.name.slice(4)]) {
          bbn.fn.extend(o, bbn.wc.defaults[this.$options.name.slice(4)]);
        }
        return o;
      },
      methods: {
        ...
        */
        getPopup() {
          return;
          let popup = bbn.wc.getPopup(this);

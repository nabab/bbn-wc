(bbn => {
   ...
   */
  Object.defineProperty(bbn.wc.mixins, 'input', {
    configurable: false,
    writable: false,
    value: {
      props: {
      ...
      computed: {
        ...
        isDisabled(){
          ...
          return this.disabled || (bbn.wc.isComponent(form) && form.disabled);
        }
      },
      methods: {
        resetValue(){
        ...
        isValid(e, setError = true){
          const $this = bbn.wc.isComponent(e) ? e : this,
              ...
              if ( !validity.valid || specificCase ){
                ...
                if (setError) {
                  ...
                  `;
                    ...
                    alert("To do in input validation!");
                    new Vue({
          ...
          let getLastElement = elem => {
            if ( bbn.wc.isComponent(elem) && elem.$refs && elem.$refs.element ){
